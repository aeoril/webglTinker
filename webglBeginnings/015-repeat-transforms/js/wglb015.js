...
( function () {
  ...
  window.addEventListener( 'load', function () {
    ...
    var urlObjs = [
      ...
      {key: 'VSSource', url: 'glsl/wglb015_vs.glsl'},
      {key: 'FSSource', url: 'glsl/wglb015_fs.glsl'}
    ...
    function animate ( timestamp, options ) {
      ...
      if ( resized || options.render ) {
        ...
        for ( ii = 0; ii < 5; ii++ ) {
          ...
          transformMatrix = m3.multiply( scaleMatrix, transformMatrix );
          transformMatrix = m3.multiply( rotationMatrix, transformMatrix );
          transformMatrix = m3.multiply( translationMatrix, transformMatrix );
    ...
    function finish ( responsesObj ) {
      ...
      function reset () {
        ...
        translationX = Math.floor( gl.canvas.clientWidth / 6 );
        translationY = Math.floor( gl.canvas.clientHeight / 6 );
